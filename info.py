...
BOT_TOKEN = environ.get('BOT_TOKEN', "8518276595:AAEa5pp8iYUYtj8-5le0Dx3XZSrxbWEEyi8")    # Bot token from @BotFather
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '--1003703472560')  # Log channel id (make sure bot is admin)
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/Etienneplus/24")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/Etienneplus/23")   # Second tutorial link for verification
